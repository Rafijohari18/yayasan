...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <h4 class="font-weight-bold py-3 mb-4">
      <span class="text-muted font-weight-light">Alumni  /</span> Tambah <span class="text-muted"></span>
    </h4>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form enctype="multipart/form-data" action="{{ route('alumni.store') }}" method="POST">
            @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control @error('masuk_tahun') is-invalid @enderror" id="masuk_tahun" name="masuk_tahun" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control @error('tamat_tahun') is-invalid @enderror" id="tamat_tahun" name="tamat_tahun" required>
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control @error('sekolah_ke') is-invalid @enderror" required id="sekolah_ke" name="sekolah_ke">
            </div>
          </div>
